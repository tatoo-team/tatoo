...
public class SemanticStack {
   ...
   */
  public SemanticStack(int capacity) {
  ...
  public void push_float(float value) {
    push_int(Float.floatToRawIntBits(value));
  }
  ...
  public long pop_long() {
    return (((long)pop_int())<<32) | (pop_int() & 0xFFFFFFFFL);
  }
  ...
  public void push_double(double value) {
    push_long(Double.doubleToRawLongBits(value));
  }
